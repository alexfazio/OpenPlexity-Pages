...
def custom_query_api(system_prompt):
    from openai import OpenAI
    from dotenv import load_dotenv
    import os

    # logging.info("STARTING custom_query_api()")
    ...
    # Access the API key
    custom_api_endpoint = os.getenv("custom_api_endpoint", "http://localhost:5000/v1")
    custom_api_key = os.getenv("custom_api_key", 'na')
    ...
    client = OpenAI(api_key=custom_api_key, base_url=custom_api_endpoint)
    ...
    # logging.info("RESULT custom_query_api()")

    # print(response.choices[0].message.content)

    # logging.info("ENDING custom_query_api()")
